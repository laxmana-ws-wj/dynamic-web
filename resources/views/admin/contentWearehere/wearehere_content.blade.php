                ...
                <div class="row grid-margin">
                    <div class="col-12">
                        <div class="d-flex justify-content-between" style="padding:10px;">
                            <div>
                                <h5>We Are Here Content</h5>
                            </div>
                            <div>
                                {{-- <span class="pull-right btn-group">
                                    <a class="btn btn-sm btn-success" href="{{route('weareherecontent.create')}}"><i
                    ...
                    <table id="simpletable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <td class="action-icon">
                                <a href="{{ route('weareherecontent.edit',$item->id )}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                ...
                                <form id="delete-form" action="{{ route('weareherecontent.destroy',$item->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    {{method_field('DELETE')}}
                                </form> --}}
                            </td>
