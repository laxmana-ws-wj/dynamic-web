    ...
    <div class="page-body">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form id="number_form" action="{{ route('service.store') }}" method="post" autocomplete="off" enctype="multipart/form-data" novalidate>
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="icon" id="icon" placeholder="icon"
                                        value="{{ old('icon') }}">
                                    @if ($errors->has('icon'))
                                    <span class="messages">{{ $errors->first('icon') }}</span>
                                    @endif
                                </div>
                            </div>
                                <div class="form-group">
