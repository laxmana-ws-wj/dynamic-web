                    ...
                    <table id="simpletable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <td class="action-icon">
                                <a href="{{ route('service.edit',$item->id )}}" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                ...
                                <form id="delete-form" action="{{ route('service.destroy',$item->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    {{method_field('DELETE')}}
                                </form> --}}
                            </td>
