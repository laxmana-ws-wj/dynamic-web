                        ...
                        <div class="d-flex justify-content-between" style="padding:10px;">
                            ...
                            <div>
                                 <span class="pull-right btn-group">
                                    <a class="btn btn-sm btn-success" href="{{ route('gallarycontent.create') }}"><i class="feather icon-plus"></i></a>
                ...
                <div class="dt-responsive table-responsive">
                    <table id="simpletable" class="table table-striped table-bordered" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td width="50%"><img src='{{ asset("public/gallary/gallary_images/$item->image")}}' height="100px";width="100px"; ></td>
                                        ...
                                        <div class="modal fade" id="small-Modal{{$item->id}}" tabindex="-1" role="dialog">
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form id="delete-form{{ $item->id }}" action="{{ route('gallarycontent.destroy',$item->id) }}" method="POST">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <h6 class="modal-title">Are you sure you want to delete this Gallary Image?</h6>
                                                                {{method_field('DELETE')}}  
                                                        </div>
