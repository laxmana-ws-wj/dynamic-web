    ...
    <div class="page-body">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form id="number_form" action="{{ route('termconditioncontent.update',$termconditioncontent->id) }}" method="post" autocomplete="off" enctype="multipart/form-data" novalidate>
                    {{ csrf_field() }}
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-12">
